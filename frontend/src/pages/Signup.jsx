  ...
  return (
    <div className="w-full h-screen" >
      ...
      <div className="bg-slate-700 w-4/5 h-screen m-auto flex flex-col align-center justify-center items-center">
        {/* 로고 */}
        <img src="../ImgAssets/TypoIconLogo.png" alt="TypoIconLogo" className="login-Logo my-10"/>
        <div className="description text-white text-sm font-sans mt-10 mb-2 text-justify">
          스팀모아는 더 나은 서비스를 제공하기 위해 회원가입 단계에서 유저의 스팀 계정 인증을 거치고 있습니다. 아래의 버튼을 눌러 Steam을 통한 회원가입을 진행하게 되면 스팀 모아는 귀하의 Steam ID 정보를 제공받게됩니다. 해당 정보를 바탕으로 Steam Web API에서 귀하 계정의 공개 정보(프로필 이름, 아바타 및 게임 목록 등)를 가져올 수 있습니다. 회원가입을 진행하시면 위 정보 제공에 동의한 것으로 간주됩니다. 
        </div>
        <div className="description text-white text-sm font-sans mt-2 mb-10 text-justify">
          스팀모아는 Valve Corporation 및 Steam과 관련이 없으며, 
          언제든지 계정을 삭제할 수 있습니다. 
        </div>
        {/* 스팀 로그인 버튼 */}
        <img src="../ImgAssets/steam_signin.png" alt="" onClick={handleSteamAuth} className="login-Logo my-10"/>
      </div>
    </div>
  );
};
