...
const SignupForm = (props) => {
  ...
  const onChange = (e) => {
    ...
    if (target == "user_service_id") setUser({ ...user, service_id: e.target.value });
    else if (target == "user_name") setUser({ ...user, name: e.target.value });
    else if (target == "user_service_pw") setUser({ ...user, service_pw: e.target.value });
        ...
        <div className="signup-container">
          ...
          <div className="signup-form">
            <div>
              ...
              <input id="user_service_id" type="text" value={user.service_id} onChange={onChange} />
              <span>아이디가 중복됩니다</span>
              <button>아이디 중복 확인</button>
            </div>
            <div>
              <label htmlFor="user_name">NAME</label>
              <input id="user_name" type="text" value={user.name} onChange={onChange} />
            </div>
            <div>
