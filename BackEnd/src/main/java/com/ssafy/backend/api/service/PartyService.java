...
public interface PartyService {
    ...
    // 파티 전체 목록
    List<PartylistDTO>  getPartyList(int page);
     ...
     */
    List<PartylistDTO> searchPartyList(int page, String searchString, String[] tags, String partyStatus, String sortString);
